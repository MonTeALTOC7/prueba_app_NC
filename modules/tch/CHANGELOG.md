...
## Integración App Maestra 1.1.0 — 2026-09-19

- Tema ejecutivo claro compartido y tamaños de lectura revisados.
- Inicio sin evaluaciones distingue ausencia de datos de producción cero.
- Consulta de una suerte incluye evolución de hasta 20 proyecciones biométricas guardadas.
- Control de columnas en tablas simples compatible con preferencias locales.
- Validación estática reconoce manifest y service worker de la App Maestra integrada.
- Motor y versión biométrica 2.7.2 conservados; sin migración de bases ni cambios de fórmulas. Validación estática y 22 pruebas existentes aprobadas.
