...
const integrated = fs.existsSync(path.join(root, "../../core/module-registry/registry.js"));
const pwaRoot = integrated ? path.resolve(root, "../..") : root;
for (const file of ["manifest.webmanifest", "sw.js"]) assert.ok(fs.existsSync(path.join(pwaRoot,file)), `Falta PWA: ${file}`);
